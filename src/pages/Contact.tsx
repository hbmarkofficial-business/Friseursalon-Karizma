...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Kontakt & Termin | HAIR HAUS Aachen</title>
        <meta 
          name="description" 
          content="Kontaktieren Sie HAIR HAUS in Aachen. Vereinbaren Sie Ihren Termin über unseren Chatbot oder rufen Sie uns an. Di-Fr 09-19 Uhr, Sa 09-16 Uhr." 
        />
        <link rel="canonical" href="https://hairhaus-aachen.de/kontakt" />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "logo": "https://hairhaus-aachen.de/images/logo.png",
            "image": "https://hairhaus-aachen.de/images/shop.jpg",
            ...
            "sameAs": [
              "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d40363.295371514025!2d6.0030820486328!3d50.781024099999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c09956e7471fa3%3A0xba7e213707899c8!2sFriseursalon%20Karizma!5e0!3m2!1sde!2sde!4v1770319004546!5m2!1sde!2sde",
              ...
              <AnimateOnScroll animation="slide-right" className="order-2 lg:order-2">
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a 
                          href="mailto:info@hairhaus-aachen.de" 
                          className="text-muted-foreground hover:text-primary transition-colors"
                        >
                          info@hairhaus-aachen.de
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="aspect-video rounded-sm overflow-hidden border border-border mt-8">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d40363.295371514025!2d6.0030820486328!3d50.781024099999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c09956e7471fa3%3A0xba7e213707899c8!2sFriseursalon%20Karizma!5e0!3m2!1sde!2sde!4v1770319004546!5m2!1sde!2sde"
                      width="100%"
                      height="100%"
                      ...
                      title="Standort HAIR HAUS Aachen"
                    />
                  </div>
                </div>
              </AnimateOnScroll>
